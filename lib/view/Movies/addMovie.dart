      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField('Enter movie title'),
            ...
            const SizedBox(height: 16),
            _buildLabel('Trailer'),
            _buildPlaceholderButton('Choose Trailer File'),

            const SizedBox(height: 16),
            _buildLabel('Full Movie File'),
            _buildPlaceholderButton('Choose Movie File'),
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          items: [
            DropdownMenuItem(value: 'Action', child: styleText(text: "Action", fSize: 20, color: mainColor2!)),
            DropdownMenuItem(value: 'Drama', child: styleText(text: "Drama", fSize: 20, color: mainColor2!)),
            DropdownMenuItem(value: 'Thriller', child: styleText(text: "Thriller", fSize: 20, color: mainColor2!)),
            DropdownMenuItem(value: 'Romance', child: styleText(text: "Romance", fSize: 20, color: mainColor2!)),
            DropdownMenuItem(value: 'Documentary', child: styleText(text: "Documentary", fSize: 20, color: mainColor2!)),
          ],
          onChanged: (_) {},
        ),
      ),
  ...
  Widget _buildPlaceholderButton(String text) {
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        onPressed: () {
          // Placeholder: Would open file picker if using StatefulWidget
        },
        style: ElevatedButton.styleFrom(
